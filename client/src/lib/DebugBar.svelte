<script lang="ts">
	...
	import { createDebugBarStore, type DebugBarStore } from './store.js';
	import type { DebugBarConfig, RequestInfo, TabType } from './types.js';
	import RequestList from './RequestList.svelte';
	import RequestDetail from './RequestDetail.svelte';
	import QueryList from './QueryList.svelte';
	import ErrorList from './ErrorList.svelte';

	export let config: DebugBarConfig;

	let store: DebugBarStore;
	...
	function handleRequestSelect(request: RequestInfo) {
